...
CREATE TABLE `PIX` (
  ...
  `Status_PIX` enum('Gerado','Expirado','Pago') NOT NULL,
  `Pagamento_Forma_idPagamento_Forma` int NOT NULL,
  PRIMARY KEY (`idPix`),
  UNIQUE KEY `idPix` (`idPix`),
  KEY `Pagamento_Forma_idPagamento_Forma` (`Pagamento_Forma_idPagamento_Forma`),
  CONSTRAINT `pix_ibfk_1` FOREIGN KEY (`Pagamento_Forma_idPagamento_Forma`) REFERENCES `Pagamento_Forma` (`idPagamento_Forma`)
