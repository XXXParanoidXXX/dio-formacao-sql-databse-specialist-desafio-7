...
CREATE TABLE `Produto_has_Estoque` (
  ...
  KEY `Estoque_idEstoque` (`Estoque_idEstoque`),
  CONSTRAINT `produto_has_estoque_ibfk_1` FOREIGN KEY (`Produto_idProduto`) REFERENCES `Produto` (`idProduto`),
  CONSTRAINT `produto_has_estoque_ibfk_2` FOREIGN KEY (`Estoque_idEstoque`) REFERENCES `Estoque` (`idEstoque`)
...
INSERT INTO `Produto_has_Estoque` VALUES (1,1,100),(2,1,100),(3,1,100),(4,1,100),(5,1,100),(6,1,100),(7,1,100),(8,1,100),(9,1,100),(10,1,100);
